!(function (e, t) {
  ...
  function u(e) {
    return e
      ? i.getStyle(e, "fontSize") || u(e.parentElement)
      : i.getStyle(window.document.documentElement, "fontSize");
  }
  function s(e, t) {
    e.classList.add(t);
  }
    ...
    var r,
      ...
      i =
        null !==
          ...
          ? o
          : window,
      s = i.document.documentElement || i.document.body,
      l = (function (e) {
        var t,
          n = e || "0",
          r = parseFloat(n),
        ...
        return [
          r,
          (null !== (t = null == o ? void 0 : o[1]) && void 0 !== t
            ? t
            : ""
          ).toLowerCase(),
        ];
    ...
    switch (l[1]) {
      ...
      case "vmin":
        return (
          (f *
            Math.min(
              i.innerWidth || s.clientWidth,
              i.innerHeight || s.clientHeight
            )) /
          100
        );
      case "vmax":
      ...
      reposition: function () {
        b(c) &&
          ...
          c.offsetHeight < i.scrollHeight
            ? (s(c, y), i.setAttribute("tabindex", "0"))
            : (l(c, y), i.removeAttribute("tabindex")));
      },
      resize: function () {
        b(c) &&
          ((c.style.left =
            (function (e, t) {
              var n = e.offsetWidth;
              return (
                -v(t) * n + parseInt(r(t, "marginLeft"), 10) + t.offsetWidth / 2
              );
            })(i, n) + "px"),
        ...
        (function (e) {
          return function (t) {
            ...
            r > 0 && l(e, E),
              n &&
                r <= 0 &&
                r < n.clientHeight + n.scrollTop - n.scrollHeight &&
                s(e, E);
          };
        })(t),
        16
  ...
  function j(e) {
    ...
    n.length === r.length && (r.concat(t).forEach(M), j(t));
  }
  function I(e) {
    var t = e.parentElement;
    f(e), t.innerHTML.replace("[]", "").replace("&nbsp;", " ").trim() || I(t);
  }
  function L(e, t) {
          ...
          (function (e, t, n, r) {
            ...
            return function (i) {
              ...
              if (u) {
                o.push(u);
                var s = i.closest(n) || i;
                return { reference: s, referenceId: s.id || i.id, body: u };
              }
            };
          })(document, i, a, f)
        )
            ...
            ? ((n = d),
              ...
              function (e) {
                ...
                return (
                  (r = o === c ? r + 1 : 1),
                  (o = c),
                  { original: i, data: t(t({}, a), { number: r }) }
                );
              })
            : function (e) {
                return e;
        ...
        .map(
          (function (e, t) {
            ...
            return function (e) {
              ...
              var u = k(r(o));
              (u.dataset.footnotePopover = ""), (u.dataset.footnoteId = i);
              var s = O(u, H),
                l = O(u, A);
              return (
                S(l, u),
  ...
  var _ = {
    ...
    contentTemplate:
      '<aside class="littlefoot__popover" id="fncontent:<% id %>"><div class="'
        .concat(H, '"><div class="')
        .concat(A, '"><% content %></div></div><div class="')
        .concat(d, '"></div></aside>'),
    buttonTemplate:
          ...
          e.exports = (function () {
            ...
            return (
              ...
              (e.prototype.add = function (e, t) {
                ...
                if ("string" == typeof e) {
                  for (
                    h[(n = { id: this.uid++, selector: e, data: t }).id] = n,
                      f = u(this.indexes, e),
                      r = 0;
                    r < f.length;
                    r++
                    ...
                    (a = (d = f[r]).key),
                      (c = s(p, (o = d.index))) ||
                        (((c = Object.create(o)).map = new i()), p.push(c)),
                      o === this.indexes.default && this.logDefaultIndexUsed(n),
                      (l = c.map.get(a)) || ((l = []), c.map.set(a, l)),
                      l.push(n);
                  this.size++, v.push(e);
                }
              }),
              (e.prototype.remove = function (e, t) {
                if ("string" == typeof e) {
                  ...
                  for (n = u(this.indexes, e), o = 0; o < n.length; o++)
                    for (r = n[o], i = f.length; i--; )
                      if (((c = f[i]), r.index.isPrototypeOf(c))) {
                        if ((s = c.map.get(r.key)))
                          for (a = s.length; a--; )
                            (l = s[a]).selector !== e ||
                              (!h && l.data !== t) ||
                              (s.splice(a, 1), (v[l.id] = !0));
                        break;
                      }
                  for (o in v) delete p[o], this.size--;
                  for (o in p) d.push(p[o].selector);
                }
              }),
              (e.prototype.queryAll = function (e) {
                ...
                for (t = 0, r = d.length; t < r; t++)
                  for (
                    i = d[t], n = 0, o = (a = this.matches(i)).length;
                    n < o;
                    n++
                  )
                    s[(u = a[n]).id]
    ...
    !(function (e, t) {
      ...
      function m(e, o, i) {
        var a = !!(
          ...
          c = a ? r : n,
          u = c[e];
        u || ((u = new t()), (c[e] = u), document.addEventListener(e, h, a)),
          u.add(o, i);
      }
      function g(e, t, o) {
        var i = !!(
        ...
        c &&
          (c.remove(t, o),
          c.size || (delete a[e], document.removeEventListener(e, h, i)));
      }
      function y(e, t, n) {
  ...
  function J(e) {
    ...
    return (
      ...
      $("click", a, { signal: i }),
      $("keyup", c, { signal: i }),
      $("gestureend", u, { signal: i }),
      G("scroll", u, { signal: i }),
      G("resize", s, { signal: i }),
      z.on("mouseover", V, l),
      z.on("mouseout", V, f),
      function () {
        o.abort(), z.off("mouseover", V, l), z.off("mouseout", V, f);
      }
    );
  }
  function K(e) {
      ...
      r = (function (e, t) {
        var n = e.footnotes,
          ...
          o = function (e) {
            return function (n) {
              n.isReady() &&
                (n.dismiss(t.dismissCallback), setTimeout(n.remove, e));
            };
          },
          i = function (e) {
            return function (r) {
    ...
    return {
      activate: function (e, t) {
        void 0 === t && (t = n.activateDelay), r.activate(e, t);
      },
      dismiss: function (e, t) {
